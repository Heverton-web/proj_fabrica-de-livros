...
```mermaid
%% legenda: Personas e Segmentação: Conhecendo o Viajante
flowchart LR
  A[Consumidor conectado] --> B[Construção de personas com dados q]
  B --> C[Segmentação comportamental, demogr]
  C --> D[Da segmentação à personalização da]
