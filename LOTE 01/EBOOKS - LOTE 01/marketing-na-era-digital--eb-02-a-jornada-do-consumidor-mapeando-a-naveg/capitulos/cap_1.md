...
```mermaid
%% legenda: Funil de Vendas e Jornada do Cliente: Mapeando a Navegação
flowchart LR
  A[Consumidor conectado] --> B[Modelos de funil: AIDA, TOFU-MOFU-]
  B --> C[Micro-momentos e a decisão de comp]
  C --> D[Alinhamento de jornada a objetivos]
