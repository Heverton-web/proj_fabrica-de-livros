...
![O terminal como cabine de comando e os concorrentes no mapa do ecossistema](imagens/diagramas/dia_livro_01_1caed34ece.png)
...
![O loop do agente — como uma mensagem vira mudança de arquivo](imagens/diagramas/dia_livro_02_00a6221015.png)
...
![Checklist de decolagem — do binário instalado ao primeiro plano de voo](imagens/diagramas/dia_livro_03_fee0e91a71.png)
...
![Roteador de provedores — o caminho de uma requisição até o modelo](imagens/diagramas/dia_livro_04_e12e5d0eb0.png)
...
![O fluxo Build/Plan — o ciclo de operação da TUI no dia a dia](imagens/diagramas/dia_livro_05_ce295a6d94.png)
...
![Automação com opencode run — do script ao CI, sem interface interativa](imagens/diagramas/dia_livro_06_d005e47951.png)
...
![O sistema de permissões — o envelope de operação do agente](imagens/diagramas/dia_livro_07_0ee77c94bf.png)
...
![O agente como hub — MCP servers, plugins e ferramentas orbitando o núcleo](imagens/diagramas/dia_livro_08_300d9e115d.png)
...
![A malha aérea da empresa — servidor headless, web, attach e share](imagens/diagramas/dia_livro_09_090968a477.png)
...
![O envelope profissional — segurança, custo e armadilhas em um fluxo único](imagens/diagramas/dia_livro_10_c3bc22c7f6.png)
