...
```mermaid
%% legenda: Plataformas de Nicho e Comunidades: Pinterest, X/Twitter, Re
flowchart LR
  A[Consumidor conectado] --> B[Pinterest: busca visual e descober]
  B --> C[X/Twitter e Reddit: presença em co]
  C --> D[Grupos e fóruns: autoridade, atend]
