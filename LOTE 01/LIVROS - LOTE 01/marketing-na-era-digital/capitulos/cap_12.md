...
```mermaid
%% legenda: SEO: Conquistando Visibilidade Orgânica
flowchart LR
  A[Consumidor conectado] --> B[Como os mecanismos de busca funcio]
  B --> C[SEO on-page, técnico e off-page: c]
  C --> D[Estratégia de palavras-chave e int]
