...
```mermaid
%% legenda: Google Ads e SEM: A Rota da Intenção de Compra
flowchart LR
  A[Consumidor conectado] --> B[Fundamentos de SEM/PPC: leilão, Ín]
  B --> C[Estrutura de campanhas, grupos de ]
  C --> D[Otimização e mensuração: CTR, conv]
