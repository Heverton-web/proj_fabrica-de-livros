---
title: "CLAUDE.md, AGENTS.md e Rules: a engenharia da memória e das regras do projeto"
...
flowchart TD
    ...
    AAIF --> AGENTS["AGENTS.md (OpenAI): instruções universais"]
    AAIF --> MCP["MCP (Anthropic): conexão universal"]
    AAIF --> GOOSE["goose (Block): framework de agente"]
    AAIF --> MEMBROS[Membros platinum: AWS, Anthropic, Google, Microsoft, OpenAI...]
    MEMBROS --> GOV[Governança neutra e processo aberto]
    GOV --> EVO[Evolução ordenada dos padrões]
```
