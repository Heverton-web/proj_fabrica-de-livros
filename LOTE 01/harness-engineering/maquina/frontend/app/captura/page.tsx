      ...
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
            Baixe o guia gratuito de Harness Engineering
          </h1>
          <p className="text-gray-300 text-lg">
            As 25 armadilhas de harness engineering: o que trava quem coloca agentes
            em produção. Preencha o formulário e receba gratuitamente.
          </p>
        </div>
