    ...
    <main>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="section-heading text-gray-900 mb-6">
            Seu agente já te deu um desses sustos?
          </h2>
          <div className="grid md:grid-cols-3 gap-6 mt-10">
            {[
              {
                icon: "😤",
                title: "Agente erra em silêncio",
                desc: "O modelo responde com confiança e erra — sem teste, sem alerta, sem rastro. Você só descobre quando custa caro.",
              },
              {
                icon: "🤯",
                title: "Sem método de verificação",
                desc: "Prompt melhor não é resposta. Sem harness, o agente continua um palpite bem escrito.",
              },
              {
                icon: "😰",
                title: "Medo de colocar em produção",
                desc: "Você sabe o potencial dos agentes, mas não confia para rodar de verdade. E com razão.",
              },
            ].map((item) => (
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="section-heading text-gray-900 mb-6">
            Apresentamos: Livros/Harness Engineering
          </h2>
      ...
      <footer className="py-8 bg-gray-950 text-gray-500 text-center text-sm">
        <p>© {new Date().getFullYear()} Livros/Harness Engineering. Todos os direitos reservados.</p>
        <p className="mt-2">
