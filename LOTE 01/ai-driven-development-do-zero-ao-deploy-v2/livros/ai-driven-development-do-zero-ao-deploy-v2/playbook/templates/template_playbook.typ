...
// Figuras de IMAGEM (diagramas Mermaid) — pagina propria A4 horizontal,
// imagem ocupando a pagina inteira (correcao: diagramas pequenos/ilegiveis)
...
// Figuras de TABELA — fluxo normal da pagina (compactas)
...
// Tabelas: cabem na mancha grafica e quebram palavras longas (correcao: sobreposicao)
#show table: it => block(width: 100%)[
  #set text(size: 9pt)
  #set table(inset: (x: 4pt, y: 3pt), stroke: 0.5pt)
  it
]
#show table.cell: it => {
  set text(breakable: true)
  it
}
