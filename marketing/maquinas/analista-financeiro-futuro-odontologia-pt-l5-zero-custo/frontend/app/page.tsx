    ...
    <main>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="section-heading text-gray-900 mb-6">
            Apresentamos: Analista Financeiro Futuro Odontologia Pt L5 Zero Custo
          </h2>
      ...
      <footer className="py-8 bg-gray-950 text-gray-500 text-center text-sm">
        <p>© {new Date().getFullYear()} Analista Financeiro Futuro Odontologia Pt L5 Zero Custo. Todos os direitos reservados.</p>
        <p className="mt-2">
