      ...
      <div className="max-w-md w-full">
        <div className="card text-center">
          ...
          <p className="text-gray-600 mb-6">
            Você está adquirindo <strong>O Dentista Gestor: Finanças de Clínica com IA</strong> — do caos do fim de expediente ao painel de comando
          </p>
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">Pagamento único · PDF + EPUB</p>
          </div>

          <div className="space-y-3 text-left text-sm text-gray-600 mb-8">
            <div className="flex items-center gap-2">
              <span className="text-green-500">✓</span> 4 capítulos: fluxo de caixa, ticket médio, custos e KPIs
            </div>
            <div className="flex items-center gap-2">
              <span className="text-green-500">✓</span> Planilhas e códigos executáveis com IA gratuita
            </div>
            <div className="flex items-center gap-2">
              <span className="text-green-500">✓</span> Dashboards (Looker Studio e Power BI) passo a passo
            </div>
            <div className="flex items-center gap-2">
              <span className="text-green-500">✓</span> Conformidade: LGPD, CNES, Simples Nacional e CFO
            </div>
            <div className="flex items-center gap-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left mb-6">
            ...
            >
              {status === "loading" ? "PROCESSANDO..." : "PAGAR R$ 97 →"}
            </button>
          </form>
