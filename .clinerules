...
- **2026-08-11 Produção completa série 5 (coleção `agentic-design-patterns`):**
  ...
  `relatorios/2026-08-11-producao-completa-agentic-design-patterns.md/.pdf`.
